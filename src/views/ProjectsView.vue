<template>
  <section class="projects">
    <div class="container">
      <h1 class="section-title">Mes <span class="accent">Projets</span></h1>
      <p class="projects__sub">Une sélection de ce sur quoi j'ai travaillé.</p>
...
<script setup>
// ✏️  Remplace ces projets par les tiens
const projects = [
  {
    id: 1,
    title: 'Astrobot',
